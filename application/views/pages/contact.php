...
<section class="contacts-wrap">
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="contact-office-img">
                    <img class="img-responsive" src="<?php echo ASSET_PATH; ?>images/soccer/contact-office-img.jpg" alt="contact-office-img">	
                </div>
    ...
    <div class="contacts-map">
        <img class="img-responsive" src="<?php echo ASSET_PATH; ?>images/soccer/contacts-map.jpg" alt="contacts-map">
    </div>
</section>
<!--CONTACT WRAP END-->
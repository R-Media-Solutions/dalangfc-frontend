                ...
                <div class="info">
                    <div class="wrap">
                        <ul class="breadcrumbs">
                            ...
                            <li>Staff / Official</li>
                        </ul>
                        <h1>Staff / Official</h1>
                    </div>
                </div>
            </div>	
        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="staff-item">
                                        <a href="staff.html">
                                            ...
                                            <img src="<?php echo ASSET_PATH; ?>images/soccer/stuff-person.jpg"  alt="person-slider">
                                        </a>	
                                    </div>
                                </div>                    
                                <div class="col-md-4">
                                    <div class="staff-item">
                                        <a href="staff.html">
                                            ...
                                            <img src="<?php echo ASSET_PATH; ?>images/soccer/player-2.jpg"  alt="person-slider">
                                        </a>	
                                    </div>
                                </div>
                                <div class="col-md-4 ">
                                    <div class="staff-item">
                                        <a href="staff.html">
                                            ...
                                            <img src="<?php echo ASSET_PATH; ?>images/soccer/player-3.jpg"  alt="person-slider">
                                        </a>	
                                    </div>
                                </div>
